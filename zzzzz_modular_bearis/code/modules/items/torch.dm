//Torches
/obj/item/torch
	icon = 'zzzzz_modular_bearis/icons/obj/torches.dmi'
	icon_state = "torch0"
	item_state = "torch0"
	name = "Torch"
...
/obj/item/torch/self_lit
	...
	desc = "A torch with a self-igniting sheath on top."
	self_lighting = 1
...
/obj/item/torch/proc/light(var/mob/user, var/manually_lit = FALSE)//This doesn't seem to update the icon appropiately, not idea why.
	...
	playsound(src, 'sound/effects/Custom_flare.ogg', 50, 0, -1)
